...
from. import views
from.views import HomeView,ItemDetailView,OrderSummaryView,CheckoutView,PaymentView,TestItemDetailView,TestOrderSummaryView#,FavListView
...
urlpatterns = [
   ...
   path('product/<slug>',views.product_detail_view,name='product-detail'),
   ...
   # path('test/',HomeView.as_view(),name='test_index'),
   path('', views.home_view, name='test_index'),
   #path('test_product/<slug>',TestItemDetailView.as_view(),name='test-product-detail'),
   path('test_product/<slug>',views.product_detail_view,name='test-product-detail'),
  ...
  # path('favList/',FavListView.as_view(),name='FavList')
   ...
   path('history/',views.test_function_with_index,name='test_function_with_index')
